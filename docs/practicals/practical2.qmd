...
`r fitb(confidenceInterval[1] |> round(2))`

The upper confidence interval is: `r fitb(confidenceInterval[2] |> round(2))`
:::
...
The result of this step is: `r fitb(step1 |> round(2))` (round to 2 decimal places)
...
The result of this step is: `r fitb(step2 |> round(2))` (round to 2 decimal places)
...
The result of this step is: `r fitb(step3 |> round(2))` (round to 2 decimal places)
...
The result of this step is: `r fitb(step4 |> round(2) )` (round to 2 decimal places)
...
The result of this step is: `r fitb(step5 |> round(2))` (round to 2 decimal places)
...
The result of this step is: `r fitb(step6  |> round(2))` (round to 2 decimal places)
...
The pooled SD is: `r fitb(pooled_sd |> round(2))`
:::
...
The effect size is: `r fitb(abs(effectSize) |> round(2))` (note: effect size is always positive)
:::
...
sampleSize <- power.t.test(d = effectSize, sig.level = 0.05, power = 0.8, type = "two.sample")$n |> round(0)
