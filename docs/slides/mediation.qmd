...
That is, from a theoretical perspective, mediation is hypothesising about *why* something happens in a relationship, and suggesting that the relationship can be explained by the mediator variable. 
...
## Step 4: Bootstrapping the mediation model
