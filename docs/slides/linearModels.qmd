...
- In regression, the null hypothesis is that the line of best fit is no better at predicting the y variable than the mean of the y variable when the x variable = 0
