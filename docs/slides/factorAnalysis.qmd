...
knitr::include_graphics("img/pcafa.png") 
```
...
# The scree plot and parallel analysis suggest that we should retain 2 factors

## Step 6: Perform factor analysis (with reduced number of factors) {.smaller .scrollable}
